package com.hunters.treasuremap;
...
public class MapsActivityCurrentPlace extends AppCompatActivity
    ...
    static final LatLng UOM = new LatLng(-37.798535, 144.960605);
    ...
    public void showFriends(View v){
        ...
        Drawable myDrawable = getResources().getDrawable(R.drawable.user_icon_demo);
        Bitmap myLogo = ((BitmapDrawable) myDrawable).getBitmap();
        myLogo = Bitmap.createScaledBitmap(myLogo,myLogo.getWidth() / 3, myLogo.getHeight() / 3, false);
        mMap.addMarker(new MarkerOptions()
                        .position(UOM)
                        .title("Your Friend A was Here at " + currentDateTimeString)
                        .icon(BitmapDescriptorFactory.fromBitmap(myLogo)));
        showFriends = true;
    }

    public void stopShowFriends(View v){
        mMap.clear();
        showFriends = false;
    }
}
